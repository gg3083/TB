...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/hp-layui.css" />
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav hp-nav-none">
                <li class="layui-nav-item">
                    <a href="javascript:;"  class="hp-user-name">
                        <img src='${user.userImg}' class="layui-circle-img"><span class="hp-kd">${sessionScope.user.userName}</span>
                    </a>
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/button.html" href="javascript:;">数据分析</a>
                        </dd>
                        <dd>
                            <a class="hp-tab-add" hp-href="/note" href="javascript:;">文章管理</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/button.html" href="javascript:;">个人资料</a>
                        </dd>
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/form.html" href="javascript:;">我的帖子</a>
                        </dd>
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/form.html" href="javascript:;">收到的回复</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/button.html" href="javascript:;">用户设置</a>
                        </dd>
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/form.html" href="javascript:;">权限设置</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a class="hp-tab-add" hp-href="demo/button.html" href="javascript:;">按钮</a>
                        </dd>
                        <dd>
...
<script>
    // 配置
    layui.config({
        base: '${pageContext.request.contextPath}/hpModules/' // 扩展模块目录
    }).extend({ // 模块别名
        hpTab: 'hpTab/hpTab',
